...
- 导入路径：`gnalloy.org/handler-traffic`
- 仓库：`github.com/gnalloy/handler-traffic`
- 默认分支：`dev`
- 预览安装：`go get gnalloy.org/handler-traffic@dev`
- 许可证：Apache-2.0
...
本仓库负责：Gnalloy Pipeline 的流量整形与限速 Handler。
